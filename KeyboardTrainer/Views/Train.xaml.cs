    ...
    public partial class Train : Window
    {
        ...
        private string GetAvaibleChrs(MLanguage language, int numOfLesson)
        {
            ...
            if (language == MLanguage.RUSSIAN)
            {
                ...
                if (numOfLesson == 4)
                {
                    avaibleChrs = "аопрвлыд";
                }

                if (numOfLesson == 5)
                {
                    avaibleChrs = "аопрвлыдфж";
                }

                if (numOfLesson == 6)
                {
                    avaibleChrs = "аопрвлыдфжэ"; //middle line
                }

                if (numOfLesson == 7)
                {
                    avaibleChrs = "аопрвлыдфжэен";
                }

                if (numOfLesson == 8)
                {
                    avaibleChrs = "аопрвлыдфжэенкг";
                }

                if (numOfLesson == 9)
                {
                    avaibleChrs = "аопрвлыдфжэенкгуш";
                }

                if (numOfLesson == 10)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщ";
                }

                if (numOfLesson == 11)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйз";
                }

                if (numOfLesson == 12)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъ"; //up line
                }

                if (numOfLesson == 13)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъми";
                }

                if (numOfLesson == 14)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъмист";
                }

                if (numOfLesson == 15)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъмистчь";
                }

                if (numOfLesson == 16)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъмистчьяб";
                }

                if (numOfLesson == 17)
                {
                    avaibleChrs = "аопрвлыдфжэенкгушцщйзъмистчьябю";//all lines
                }
            }
            else if (language == MLanguage.ENGLISH)
            {
                ...
                if (numOfLesson == 4)
                {
                    avaibleChrs = "fjghdksl";
                }

                if (numOfLesson == 5)
                {
                    avaibleChrs = "fjghdksla";
                }

                if (numOfLesson == 6)
                {
                    avaibleChrs = "fjghdksla"; //middle line
                }

                if (numOfLesson == 7)
                {
                    avaibleChrs = "fjghdkslty";
                }

                if (numOfLesson == 8)
                {
                    avaibleChrs = "fjghdksltyru";
                }

                if (numOfLesson == 9)
                {
                    avaibleChrs = "fjghdksltyruei";
                }

                if (numOfLesson == 10)
                {
                    avaibleChrs = "fjghdksltyrueiwo";
                }

                if (numOfLesson == 11)
                {
                    avaibleChrs = "fjghdksltyrueiwoqp";
                }

                if (numOfLesson == 12)
                {
                    avaibleChrs = "fjghdksltyrueiwoqp"; //up line
                }

                if (numOfLesson == 13)
                {
                    avaibleChrs = "fjghdksltyrueiwoqpvb";
                }

                if (numOfLesson == 14)
                {
                    avaibleChrs = "fjghdksltyrueiwoqpvbcn";
                }

                if (numOfLesson == 15)
                {
                    avaibleChrs = "fjghdksltyrueiwoqpvbcnxm";
                }

                if (numOfLesson == 16)
                {
                    avaibleChrs = "fjghdksltyrueiwoqpvbcnxmz";
                }

                if (numOfLesson == 17)
                {
                    avaibleChrs = "fjghdksltyrueiwoqpvbcnxmz";//all lines
                }
            }
